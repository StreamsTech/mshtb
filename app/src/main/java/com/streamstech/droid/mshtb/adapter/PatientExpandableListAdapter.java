...
public class PatientExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    public PatientExpandableListAdapter(Context context, List<PatientGroup> expandableListDetail, FASTFormsFragment.OnListFragmentInteractionListener listener) {
        this.context = context;
        patientGroupList = new ArrayList<>(expandableListDetail);
        this.mListener = listener;
    }

    public void setData(List<PatientGroup> expandableListDetail){
        patientGroupList = new ArrayList<>(expandableListDetail);
    ...
    public Object getChild(int groupPosition, int childPosition) {
        List<Patient> taskAdapterServicePointDataList = patientGroupList.get(groupPosition).getPatientList();
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final Patient taskAdapterServicePointData = (Patient) getChild(listPosition, expandedListPosition);
        if (convertView == null) {
        ...
        expandedListTextView3.setText(taskAdapterServicePointData.getPatientid());
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        PatientGroup listTitle = (PatientGroup) getGroup(listPosition);
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
