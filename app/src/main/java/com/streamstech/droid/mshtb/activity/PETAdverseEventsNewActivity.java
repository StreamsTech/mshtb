...
import com.streamstech.droid.mshtb.fragement.PETAdverseEventFragement;
import com.streamstech.droid.mshtb.fragement.PETAdverseEventGroupFragment;
...
public class PETAdverseEventsNewActivity extends BaseSearchActivity implements BaseSearchActivity.PatientSelectionEventListener,
        DialogInterface.OnDismissListener, HistoryFragmentInteractionListener {


    ViewPager mViewPager;
    PETAdverseEventGroupFragment groupFragment;
    PETAdverseEventFragement fragment;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        groupFragment = new PETAdverseEventGroupFragment();
        fragment = new PETAdverseEventFragement();
