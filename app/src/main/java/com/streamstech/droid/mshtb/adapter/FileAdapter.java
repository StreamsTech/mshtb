...
import com.streamstech.droid.mshtb.activity.FileBrowserActivity;
import com.streamstech.droid.mshtb.data.FilePOJO;
import com.streamstech.droid.mshtb.data.FolderHistory;
...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.MyViewHolder> {
    ...
    // https://github.com/emkay-git/FileManager

    public FileAdapter(Context context, FileBrowserActivity activ) {
