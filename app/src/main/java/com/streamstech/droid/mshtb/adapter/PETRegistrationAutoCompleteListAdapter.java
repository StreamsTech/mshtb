...
public class PETRegistrationAutoCompleteListAdapter extends ArrayAdapter {
    ...
    private PETRegistrationAutoCompleteListAdapter.ListFilter listFilter = new PETRegistrationAutoCompleteListAdapter.ListFilter();

    public PETRegistrationAutoCompleteListAdapter(Context context, int resource, List<PETRegistration> storeDataLst) {
