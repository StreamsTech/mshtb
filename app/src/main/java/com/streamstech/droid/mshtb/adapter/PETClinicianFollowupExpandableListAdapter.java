...
public class PETClinicianFollowupExpandableListAdapter extends BaseExpandableListAdapter{

    private Context context;
    private List<PETHistoryGroup> historyGroups;

    public PETClinicianFollowupExpandableListAdapter(Context context, List<PETHistoryGroup> historyGroups) {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final PETClinicianFollowup data = (PETClinicianFollowup) getChild(listPosition, expandedListPosition);
        if (rootView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            rootView = layoutInflater.inflate(R.layout.activity_petclinician_followup, null);
        }
        ...
        txtHeight.setText(String.valueOf(data.getHeight()));
        txtMUAC = (EditText)rootView.findViewById(R.id.txtMUAC);
        txtMUAC.setText(String.valueOf(data.getMuac()));
        ...
        radioGroup2.checkAt(data.getBmi());
        radioGroup3 = (MultiLineRadioGroup) rootView.findViewById(R.id.radioGroup3);
        radioGroup3.checkAt(data.getAnysymptom() ? 0 : 1);
