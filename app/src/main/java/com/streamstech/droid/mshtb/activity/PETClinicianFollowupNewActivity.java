...
public class PETClinicianFollowupNewActivity extends BaseSearchActivity implements BaseSearchActivity.PatientSelectionEventListener,
        DialogInterface.OnDismissListener, HistoryFragmentInteractionListener {


    ViewPager mViewPager;
    PETClinicianFollowupGroupFragment groupFragment;
    PETClinicianFollowupFragement fragment;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        groupFragment = new PETClinicianFollowupGroupFragment();
        fragment = new PETClinicianFollowupFragement();
