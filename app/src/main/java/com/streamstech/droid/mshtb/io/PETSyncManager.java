...
public class PETSyncManager extends AsyncTask<Void, String, Boolean> {
    ...
    public PETSyncManager(Context context, SyncMessageUpdateListener syncMessageUpdateListener) {
    ...
    public static long getPendingCount() {
        long count = 0;
        count += DatabaseManager.getInstance().getSession().getPETRegistrationDao().queryBuilder()
                .where(PETRegistrationDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETEnrollmentDao().queryBuilder()
                .where(PETEnrollmentDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETSymptomDao().queryBuilder()
                .where(PETSymptomDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETTestOrderDao().queryBuilder()
                .where(PETTestOrderDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETTestResultDao().queryBuilder()
                .where(PETTestResultDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETEligibilitySymptomDao().queryBuilder()
                .where(PETEligibilitySymptomDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETTreatmentStartDao().queryBuilder()
                .where(PETTreatmentStartDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETAdherenceDao().queryBuilder()
                .where(PETAdherenceDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETFollowupDao().queryBuilder()
                .where(PETFollowupDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETClinicianFollowupDao().queryBuilder()
                .where(PETClinicianFollowupDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETClinicianTBReviewDao().queryBuilder()
                .where(PETClinicianTBReviewDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETAdverseEventFollowupDao().queryBuilder()
                .where(PETAdverseEventFollowupDao.Properties.Uploaded.eq(false)).count();
        count += DatabaseManager.getInstance().getSession().getPETFollowupEndDao().queryBuilder()
                .where(PETFollowupEndDao.Properties.Uploaded.eq(false)).count();
...
//                .addConverterFactory(GsonConverterFactory.create())
        ...
        EndpointInterface service = client.create(EndpointInterface.class);
        retrofit2.Call<ResponseBody> call = service.syncpetdatav2(Constant.TOKEN, lastUdateTime);
        try {
            ...
            if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                ...
                List<UpdateModelsPET> updateModels = new GsonBuilder()
                        .create()
                        .fromJson(new Gson()
                                .toJson(jelement.getAsJsonObject().getAsJsonArray("results")), type);
...
//        });
    ...
    private void uploadRegistration() {
        ...
        for (final PETRegistration obj : list) {
            ...
            publishProgress("Uploading registration data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
...
//            });
    ...
    private void uploadEnrollment() {
        ...
        for (final PETEnrollment obj : list) {
            ...
            publishProgress("Uploading enrollment data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadSymptom() {
        ...
        for (final PETSymptom obj : list) {
            ...
            publishProgress("Uploading symptom data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadTestOrder() {
        ...
        for (final PETTestOrder obj : list) {
            ...
            publishProgress("Uploading test order data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadTestResult() {
        ...
        for (final PETTestResult obj : list) {
            ...
            publishProgress("Uploading test result data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadEligibility() {
        ...
        for (final PETEligibilitySymptom obj : list) {
            ...
            publishProgress("Uploading eligibility data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadTreatmentStart() {
        ...
        for (final PETTreatmentStart obj : list) {
            ...
            publishProgress("Uploading treatment data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadAdherence() {
        ...
        for (final PETAdherence obj : list) {
            ...
            publishProgress("Uploading adherence data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadFollowup() {
        ...
        for (final PETFollowup obj : list) {
            ...
            publishProgress("Uploading followup data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadFollowupClinician() {
        ...
        for (final PETClinicianFollowup obj : list) {
            ...
            publishProgress("Uploading clinician followup data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadFollowupClinicianTB() {
        ...
        for (final PETClinicianTBReview obj : list) {
            ...
            publishProgress("Uploading TB followup data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadFollowupAdverse() {
        ...
        for (final PETAdverseEventFollowup obj : list) {
            ...
            publishProgress("Uploading adverse data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
...
//            });
    ...
    private void uploadFollowupEnd() {
        ...
        for (final PETFollowupEnd obj : list) {
            ...
            publishProgress("Uploading followup end data");
            try {
                retrofit2.Response<CommonResponse> response = call.execute();
                if (response.isSuccessful() && response.code() == HttpURLConnection.HTTP_OK) {
                    obj.setUploaded(true);
