...
import com.streamstech.droid.mshtb.adapter.PETClinicianTBFollowupExpandableListAdapter;
...
public class PETClinicianTBFollowupGroupFragment extends Fragment {

    private static final String ARG_COLUMN_COUNT = "column-count";
    private int mColumnCount = 1;
    PETClinicianTBFollowupExpandableListAdapter adapter;
     ...
     */
    public PETClinicianTBFollowupGroupFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static PETClinicianTBFollowupGroupFragment newInstance(int columnCount) {
        PETClinicianTBFollowupGroupFragment fragment = new PETClinicianTBFollowupGroupFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        readData();
        adapter = new PETClinicianTBFollowupExpandableListAdapter(getActivity(), groups);
    ...
    private void readData(){
        ...
        List<PETClinicianTBReview> list = dao.queryBuilder()
                .where(PETClinicianTBReviewDao.Properties.Contactqr.eq(patient.getQr()))
                .orderDesc(PETClinicianTBReviewDao.Properties.Createdtime)
                .list();

        HashMap<String, List<Object>> hashMap = new HashMap<>();
        for (PETClinicianTBReview patient : list){
